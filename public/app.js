...
// Tambahkan kode ini di app.js lu
document.getElementById('attendanceForm')?.addEventListener('submit', async (e) => {
    e.preventDefault();

    const name = document.getElementById('nameInput').value; // Sesuaikan ID input nama di HTML lu
    const status = document.getElementById('statusSelect').value; // Sesuaikan ID dropdown status di HTML lu
